...
# Minimal bootstrap file you can edit by hand before fetching real field IDs.
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Create a starter fields.json template")
    parser.add_argument("--out", default="data/fields_example.json", help="Output path")
    return parser
...
def main(argv: list[str] | None = None) -> int:
    ...
    out_path.write_text(json.dumps(DEFAULT, indent=2), encoding="utf-8")
